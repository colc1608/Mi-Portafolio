...
CREATE TABLE `ciudades` (
  ...
  `sueldo_promedio` double NOT NULL,
  `fecha_senso` datetime DEFAULT NULL,
...
INSERT INTO `ciudades` VALUES (1,'lima',250000,2500.9,'2020-03-25 10:11:12','lugar bonito'),(2,'arequipa',50000,1900.55,'2019-05-17 20:21:22','volcan');
...
INSERT INTO `products` VALUES (1,'laptop',37,'2023-11-28 00:00:00',0,1800),(3,'iphone',21,'2021-10-21 00:00:00',0,5678.99),(4,'TV Smarth',47,'2019-03-19 00:00:00',1,2400.9),(5,'teclado',19,'2019-07-26 12:00:00',1,293.55),(6,'teclado',19,'2019-07-26 12:00:00',1,293.55),(7,'eduardooo',44,'2023-11-28 00:00:00',1,44444);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_sueldo_por_poblacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_sueldo_por_poblacion`(
	IN in_sueldo_promedio double,
    IN in_poblacion int
)
BEGIN
	select * from ciudades 
    where 
    sueldo_promedio > in_sueldo_promedio and 
    poblacion > in_poblacion;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-02-23 16:33:59
